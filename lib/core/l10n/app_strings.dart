...
class AppStrings {
  ...
  static final Map<String, Map<String, String>> _strings = {
    ...
    'prev': {'en': 'Prev', 'id': 'Sblm', 'es': 'Ant', 'pt': 'Ant', 'de': 'Zurück', 'fr': 'Préc', 'ja': '前へ', 'ko': '이전', 'zh': '上一页', 'hi': 'पिछला', 'ar': 'السابق'},
    'page': {'en': 'Page', 'id': 'Halaman', 'es': 'Página', 'pt': 'Página', 'de': 'Seite', 'fr': 'Page', 'ja': 'ページ', 'ko': '페이지', 'zh': '页', 'hi': 'पृष्ठ', 'ar': 'صفحة'},
    'of': {'en': 'of', 'id': 'dari', 'es': 'de', 'pt': 'de', 'de': 'von', 'fr': 'sur', 'ja': '/', 'ko': '/', 'zh': '/', 'hi': 'का', 'ar': 'من'},
    'level': {'en': 'Level', 'id': 'Level', 'es': 'Nivel', 'pt': 'Nível', 'de': 'Level', 'fr': 'Niveau', 'ja': 'レベル', 'ko': '레벨', 'zh': '关卡', 'hi': 'स्तर', 'ar': 'مستوى'},
    'no_hints': {'en': 'No hints!', 'id': 'Tanpa petunjuk!', 'es': '¡Sin pistas!', 'pt': 'Sem dicas!', 'de': 'Keine Tipps!', 'fr': 'Sans indices!', 'ja': 'ヒントなし！', 'ko': '힌트 없음!', 'zh': '没有提示！', 'hi': 'कोई संकेत नहीं!', 'ar': 'بدون تلميحات!'},
    'hints_used': {'en': 'hints', 'id': 'petunjuk', 'es': 'pistas', 'pt': 'dicas', 'de': 'Tipps', 'fr': 'indices', 'ja': 'ヒント', 'ko': '힌트', 'zh': '提示', 'hi': 'संकेत', 'ar': 'تلميحات'},
    'can_you_solve_it': {'en': 'Can you solve it?', 'id': 'Bisakah kamu memecahkannya?', 'es': '¿Puedes resolverlo?', 'pt': 'Consegue resolver?', 'de': 'Kannst du es lösen?', 'fr': 'Pouvez-vous le résoudre?', 'ja': '解けますか？', 'ko': '풀 수 있나요?', 'zh': '你能解开吗？', 'hi': 'क्या आप इसे हल कर सकते हैं?', 'ar': 'هل يمكنك حله؟'},
    'try_msg': {'en': 'Try', 'id': 'Coba', 'es': 'Prueba', 'pt': 'Tente', 'de': 'Versuche', 'fr': 'Essayez', 'ja': '試す', 'ko': '시도', 'zh': '尝试', 'hi': 'कोशिश', 'ar': 'جرب'},
    'tap_a_number_to_start': {'en': 'Tap a number to start', 'id': 'Ketuk angka untuk memulai', 'es': 'Toca un número para empezar', 'pt': 'Toque em um número para começar', 'de': 'Tippe auf eine Zahl, um zu beginnen', 'fr': 'Appuyez sur un nombre pour commencer', 'ja': '数字をタップして開始', 'ko': '숫자를 탭하여 시작하세요', 'zh': '点击一个数字开始', 'hi': 'शुरू करने के लिए एक संख्या टैप करें', 'ar': 'انقر على رقم للبدء'},
    'cannot_divide_by_zero': {'en': 'Cannot divide by zero', 'id': 'Tidak bisa dibagi nol', 'es': 'No se puede dividir por cero', 'pt': 'Não pode dividir por zero', 'de': 'Teilung durch Null nicht möglich', 'fr': 'Impossible de diviser par zéro', 'ja': 'ゼロで割ることはできません', 'ko': '0으로 나눌 수 없습니다', 'zh': '不能除以零', 'hi': 'शून्य से विभाजित नहीं किया जा सकता', 'ar': 'لا يمكن القسمة على صفر'},
    'not_a_whole_number': {'en': 'is not a whole number', 'id': 'bukan bilangan bulat', 'es': 'no es un número entero', 'pt': 'não é um número inteiro', 'de': 'ist keine ganze Zahl', 'fr': 'n\'est pas un nombre entier', 'ja': 'は整数ではありません', 'ko': '는 정수가 아닙니다', 'zh': '不是整数', 'hi': 'पूर्ण संख्या नहीं है', 'ar': 'ليس عددًا صحيحًا'},
    'negative_or_zero': {'en': 'would be negative or zero', 'id': 'akan menjadi negatif atau nol', 'es': 'sería negativo o cero', 'pt': 'seria negativo ou zero', 'de': 'wäre negativ oder null', 'fr': 'serait négatif ou zéro', 'ja': 'はマイナスまたはゼロになります', 'ko': '는 음수 또는 0이 됩니다', 'zh': '将是负数或零', 'hi': 'नकारात्मक या शून्य होगा', 'ar': 'سيكون سالبًا أو صفرًا'},

    // Pass & Play
    'round': {'en': 'Round', 'id': 'Ronde', 'es': 'Ronda', 'pt': 'Rodada', 'de': 'Runde', 'fr': 'Manche', 'ja': 'ラウンド', 'ko': '라운드', 'zh': '回合', 'hi': 'राउंड', 'ar': 'جولة'},
    'pp_title': {'en': 'Pass & Play', 'id': 'Giliran Bermain', 'es': 'Pasar y Jugar', 'pt': 'Passar e Jogar', 'de': 'Weitergeben & Spielen', 'fr': 'Passer & Jouer', 'ja': 'パス＆プレイ', 'ko': '패스 앤 플레이', 'zh': '轮流游戏', 'hi': 'पास एंड प्ले', 'ar': 'مرر والعب'},
    'pp_player': {'en': 'Player', 'id': 'Pemain', 'es': 'Jugador', 'pt': 'Jogador', 'de': 'Spieler', 'fr': 'Joueur', 'ja': 'プレイヤー', 'ko': '플레이어', 'zh': '玩家', 'hi': 'खिलाड़ी', 'ar': 'لاعب'},
    'pp_players': {'en': 'PLAYERS', 'id': 'PEMAIN', 'es': 'JUGADORES', 'pt': 'JOGADORES', 'de': 'SPIELER', 'fr': 'JOUEURS', 'ja': 'プレイヤー', 'ko': '플레이어', 'zh': '玩家', 'hi': 'खिलाड़ी', 'ar': 'اللاعبون'},
    'pp_player_names': {'en': 'PLAYER NAMES', 'id': 'NAMA PEMAIN', 'es': 'NOMBRES', 'pt': 'NOMES', 'de': 'SPIELERNAMEN', 'fr': 'NOMS DES JOUEURS', 'ja': 'プレイヤー名', 'ko': '이름', 'zh': '玩家名称', 'hi': 'खिलाड़ी के नाम', 'ar': 'أسماء اللاعبين'},
    'pp_rounds': {'en': 'ROUNDS', 'id': 'RONDE', 'es': 'RONDAS', 'pt': 'RODADAS', 'de': 'RUNDEN', 'fr': 'MANCHES', 'ja': 'ラウンド数', 'ko': '라운드', 'zh': '回合数', 'hi': 'राउंड', 'ar': 'الجولات'},
    'pp_difficulty': {'en': 'DIFFICULTY', 'id': 'KESULITAN', 'es': 'DIFICULTAD', 'pt': 'DIFICULDADE', 'de': 'SCHWIERIGKEIT', 'fr': 'DIFFICULTÉ', 'ja': '難易度', 'ko': '난이도', 'zh': '难度', 'hi': 'कठिनाई', 'ar': 'الصعوبة'},
    'pp_time_limit': {'en': 'TIME LIMIT', 'id': 'BATAS WAKTU', 'es': 'LÍMITE DE TIEMPO', 'pt': 'LIMITE DE TEMPO', 'de': 'ZEITLIMIT', 'fr': 'LIMITE DE TEMPS', 'ja': '制限時間', 'ko': '시간 제한', 'zh': '时间限制', 'hi': 'समय सीमा', 'ar': 'حد الوقت'},
    'pp_start': {'en': 'START GAME', 'id': 'MULAI', 'es': 'INICIAR', 'pt': 'INICIAR', 'de': 'SPIEL STARTEN', 'fr': 'COMMENCER', 'ja': 'ゲーム開始', 'ko': '게임 시작', 'zh': '开始游戏', 'hi': 'खेल शुरू करें', 'ar': 'ابدأ اللعبة'},
    'pp_your_turn': {'en': 'It\'s your turn!', 'id': 'Giliranmu!', 'es': '¡Es tu turno!', 'pt': 'É a sua vez!', 'de': 'Du bist dran!', 'fr': 'C\'est votre tour !', 'ja': 'あなたの番です！', 'ko': '당신 차례입니다!', 'zh': '轮到你了！', 'hi': 'आपकी बारी!', 'ar': 'دورك!'},
    'pp_pass_device': {'en': 'Pass the device', 'id': 'Serahkan perangkat', 'es': 'Pasa el dispositivo', 'pt': 'Passe o dispositivo', 'de': 'Gerät weitergeben', 'fr': 'Passez l\'appareil', 'ja': 'デバイスを渡してください', 'ko': '기기를 넘겨주세요', 'zh': '传递设备', 'hi': 'डिवाइस सौंपें', 'ar': 'مرر الجهاز'},
    'pp_ready': {'en': 'I\'M READY', 'id': 'SAYA SIAP', 'es': 'ESTOY LISTO', 'pt': 'ESTOU PRONTO', 'de': 'ICH BIN BEREIT', 'fr': 'JE SUIS PRÊT', 'ja': '準備OK', 'ko': '준비 완료', 'zh': '准备好了', 'hi': 'मैं तैयार हूँ', 'ar': 'أنا جاهز'},
    'pp_give_up': {'en': 'Give Up', 'id': 'Menyerah', 'es': 'Rendirse', 'pt': 'Desistir', 'de': 'Aufgeben', 'fr': 'Abandonner', 'ja': '降参', 'ko': '포기', 'zh': '放弃', 'hi': 'हार मान लो', 'ar': 'استسلم'},
    'pp_round_result': {'en': 'Round Results', 'id': 'Hasil Ronde', 'es': 'Resultados de la Ronda', 'pt': 'Resultados da Rodada', 'de': 'Rundenergebnis', 'fr': 'Résultats de la Manche', 'ja': 'ラウンド結果', 'ko': '라운드 결과', 'zh': '回合结果', 'hi': 'राउंड परिणाम', 'ar': 'نتائج الجولة'},
    'pp_standings': {'en': 'Overall Standings', 'id': 'Klasemen', 'es': 'Clasificación', 'pt': 'Classificação', 'de': 'Gesamtwertung', 'fr': 'Classement Général', 'ja': '総合順位', 'ko': '종합 순위', 'zh': '总排名', 'hi': 'समग्र स्थिति', 'ar': 'الترتيب العام'},
    'pp_next_round': {'en': 'Next Round', 'id': 'Ronde Berikutnya', 'es': 'Siguiente Ronda', 'pt': 'Próxima Rodada', 'de': 'Nächste Runde', 'fr': 'Manche Suivante', 'ja': '次のラウンド', 'ko': '다음 라운드', 'zh': '下一回合', 'hi': 'अगला राउंड', 'ar': 'الجولة التالية'},
    'pp_final_result': {'en': 'Final Result', 'id': 'Hasil Akhir', 'es': 'Resultado Final', 'pt': 'Resultado Final', 'de': 'Endergebnis', 'fr': 'Résultat Final', 'ja': '最終結果', 'ko': '최종 결과', 'zh': '最终结果', 'hi': 'अंतिम परिणाम', 'ar': 'النتيجة النهائية'},
    'pp_wins': {'en': 'Wins!', 'id': 'Menang!', 'es': '¡Gana!', 'pt': 'Venceu!', 'de': 'Gewinnt!', 'fr': 'Gagne !', 'ja': '勝利！', 'ko': '승리!', 'zh': '获胜！', 'hi': 'जीता!', 'ar': 'فاز!'},
    'pp_play_again': {'en': 'Play Again', 'id': 'Main Lagi', 'es': 'Jugar de Nuevo', 'pt': 'Jogar Novamente', 'de': 'Nochmal Spielen', 'fr': 'Rejouer', 'ja': 'もう一度', 'ko': '다시 하기', 'zh': '再来一局', 'hi': 'फिर से खेलें', 'ar': 'العب مرة أخرى'},
    'pp_exit_title': {'en': 'Leave Game?', 'id': 'Keluar?', 'es': '¿Salir?', 'pt': 'Sair?', 'de': 'Spiel verlassen?', 'fr': 'Quitter ?', 'ja': 'ゲームを終了？', 'ko': '나가시겠습니까?', 'zh': '退出游戏？', 'hi': 'खेल छोड़ें?', 'ar': 'مغادرة اللعبة؟'},
    'pp_exit_desc': {'en': 'All progress in this session will be lost.', 'id': 'Semua progres sesi ini akan hilang.', 'es': 'Se perderá todo el progreso de esta sesión.', 'pt': 'Todo o progresso desta sessão será perdido.', 'de': 'Aller Fortschritt dieser Sitzung geht verloren.', 'fr': 'Toute la progression de cette session sera perdue.', 'ja': 'このセッションのすべての進行が失われます。', 'ko': '이 세션의 모든 진행 상황이 사라집니다.', 'zh': '本次所有进度将丢失。', 'hi': 'इस सत्र की सभी प्रगति खो जाएगी।', 'ar': 'سيتم فقد كل التقدم في هذه الجلسة.'},
    'pp_exit': {'en': 'Leave', 'id': 'Keluar', 'es': 'Salir', 'pt': 'Sair', 'de': 'Verlassen', 'fr': 'Quitter', 'ja': '退出', 'ko': '나가기', 'zh': '退出', 'hi': 'छोड़ें', 'ar': 'مغادرة'},
    'pass_and_play': {'en': 'Pass & Play', 'id': 'Giliran Bermain', 'es': 'Pasar y Jugar', 'pt': 'Passar e Jogar', 'de': 'Weitergeben', 'fr': 'Passer & Jouer', 'ja': 'パス＆プレイ', 'ko': '패스 앤 플레이', 'zh': '轮流游戏', 'hi': 'पास एंड प्ले', 'ar': 'مرر والعب'},
  };
